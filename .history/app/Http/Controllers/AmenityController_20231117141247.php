...
class AmenityController extends Controller
{
    ...
    public function create(Request $request){
        ...
        // $Amenity->icon_image = $validatedData['iconName'];

        $newFileName = "images/amenities/" . $request->file('icon')->getClientOriginalName();
        $newFileNamePubllic = "images_amenities_" . $request->file('icon')->getClientOriginalName();

        // Lưu tệp vào thư mục public/images/amenities
        $request->file('icon')->move(public_path('images/amenities'), $newFileNamePubllic);
