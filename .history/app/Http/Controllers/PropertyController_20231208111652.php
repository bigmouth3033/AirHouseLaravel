...
class PropertyController extends Controller
{
    ...
    public function readById(Request $request)
    {
        ...
        $property = Property::with('user', 'category', 'property_type', 'room_type', 'district', 'province', 'amenities', 'images')->where('id', $request->id)->where('property_status', 1)->first();


        $property_status = $property->where('property_status', 1)->first();
