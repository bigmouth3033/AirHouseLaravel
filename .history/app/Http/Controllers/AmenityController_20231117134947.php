...
class AmenityController extends Controller
{
    ...
    public function create(Request $request){
        ...
        $newFileName = 'images_amenities_' . $request->file('iconName')->getClientOriginalName();

        // Lưu tệp vào thư mục public/images/amenities
        $request->file('iconName')->move(public_path('images/amenities'), $newFileName);

        //Lưu hình ảnh vào thư mục public/images/amenities với tên mới
        // $request->file('iconName')->storeAs(null, $newFileName, 'public');
